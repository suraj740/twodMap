(function (factory) {
    ...
    L.Control.Search = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            this._dropdownList = this._createDropdown(this.options.categories, 'categories-list');
        ...
        _createDropdown: function (list, className) {
            var self = this;
            ...
            L.DomEvent
                .disableClickPropagation(select)
        ...
        _recordsFromLayer: function () {	//return table: key,value from layer
            // console.log('search control', this.options)
