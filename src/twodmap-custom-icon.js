...
L.VectorMarkers.Icon = L.Icon.extend({
    options: {
        ...
        spinClass: "fa-spin",
        extraClasses: "",
        pin_path: "M16,1 C7.7146,1 1,7.65636364 1,15.8648485 C1,24.0760606 16,51 16,51 C16,51 31,24.0760606 31,15.8648485 C31,7.65636364 24.2815,1 16,1 L16,1 Z",
        icon: "home",
        iconUrl: "",
        markerColor: "blue",
        iconColor: "white"
    ...
    createIcon: function(oldIcon) {
        var div, icon, options, pin_path, iconUrl;
        ...
        div.innerHTML = `<img src="${iconUrl}.png" width="${options.iconSize[0]}" height="${options.iconSize[1]}" style="filter: opacity(.5) drop-shadow(0 0 0 ${options.markerColor});"/>`;
